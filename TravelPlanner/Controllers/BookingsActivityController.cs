        ...
        public ActionResult BookActivity(BookActivityViewModel model, int activityId)
        {
            if (ModelState.IsValid)
            {
                ...
                if (authCookieUser != null)
                {
                    ...
                    {
                        return Content("You need to be authenticated in order to book an activity.");
                    }
                }
                ...
                // Validate times
                if (model.StopHour <= model.StartHour)
                {
                    return Content("Please select End Hour to be after Start Hour.");
                }
